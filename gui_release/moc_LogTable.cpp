...
#include <memory>
#include "../../gui_evaluation/administrator/LogTable.h"
...
QT_MOC_LITERAL(1, 9, 16), // "decr_child_count"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 12), // "update_child"
QT_MOC_LITERAL(4, 40, 8), // "QWidget*"
QT_MOC_LITERAL(5, 49, 1) // "c"

    },
    "LogTable\0decr_child_count\0\0update_child\0"
    "QWidget*\0c"
};
...
void LogTable::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<LogTable *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (LogTable::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LogTable::decr_child_count)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (LogTable::*)(QWidget * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LogTable::update_child)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void LogTable::decr_child_count()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void LogTable::update_child(QWidget * _t1)
{
