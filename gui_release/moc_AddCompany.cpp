...
#include <memory>
#include "../../gui_evaluation/administrator/AddCompany.h"
...
QT_MOC_LITERAL(6, 53, 21), // "on_buttonBox_accepted"
QT_MOC_LITERAL(7, 75, 21) // "on_buttonBox_rejected"

    },
    "AddCompany\0decr_child_count\0\0update_child\0"
...
void AddCompany::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddCompany::decr_child_count)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (AddCompany::*)(QWidget * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddCompany::update_child)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void AddCompany::decr_child_count()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void AddCompany::update_child(QWidget * _t1)
{
